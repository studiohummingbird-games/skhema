...
import games.studiohummingbird.skhema.types.mutable.MutableStructuredValue

interface StructuredValue
    : Intangible

fun StructuredValue(block: MutableStructuredValue.() -> Unit): StructuredValue =
    object : MutableStructuredValue {
