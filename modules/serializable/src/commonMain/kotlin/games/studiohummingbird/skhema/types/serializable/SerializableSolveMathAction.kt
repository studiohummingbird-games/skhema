/* SerializableSolveMathAction.kt
...
import games.studiohummingbird.skhema.types.SolveMathAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableSolveMathAction(
    override val eduQuestionType: EduQuestionType? = null,
...
fun PolymorphicModuleBuilder<SolveMathAction>.serializableSolveMathAction() {
    subclass(SerializableSolveMathAction::class)
}
