...
@Serializable
data class SerializableInteractAction(
...
fun PolymorphicModuleBuilder<InteractAction>.serializableInteractAction() {
    subclass(SerializableInteractAction::class)
}
