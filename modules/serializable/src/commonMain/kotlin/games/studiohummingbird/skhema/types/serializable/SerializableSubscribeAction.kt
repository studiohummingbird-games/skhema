/* SerializableSubscribeAction.kt
...
@Serializable
data class SerializableSubscribeAction(
...
fun PolymorphicModuleBuilder<SubscribeAction>.serializableSubscribeAction() {
    subclass(SerializableSubscribeAction::class)
}
