...
@Serializable
data class SerializableOrganizeAction(
...
fun PolymorphicModuleBuilder<OrganizeAction>.serializableOrganizeAction() {
    subclass(SerializableOrganizeAction::class)
}
