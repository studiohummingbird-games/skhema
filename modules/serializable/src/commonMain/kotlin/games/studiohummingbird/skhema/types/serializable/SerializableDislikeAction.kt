...
@Serializable
data class SerializableDislikeAction(
...
fun PolymorphicModuleBuilder<DislikeAction>.serializableDislikeAction() {
    subclass(SerializableDislikeAction::class)
}
