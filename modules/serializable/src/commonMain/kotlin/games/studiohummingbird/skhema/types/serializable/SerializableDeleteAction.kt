...
@Serializable
data class SerializableDeleteAction(
...
fun PolymorphicModuleBuilder<DeleteAction>.serializableDeleteAction() {
    subclass(SerializableDeleteAction::class)
}
