...
@Serializable
data class SerializableTravelAction(
...
fun PolymorphicModuleBuilder<TravelAction>.serializableTravelAction() {
    subclass(SerializableTravelAction::class)
}
