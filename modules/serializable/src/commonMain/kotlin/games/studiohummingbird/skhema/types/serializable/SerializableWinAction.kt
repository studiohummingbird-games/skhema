...
import games.studiohummingbird.skhema.types.WinAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableWinAction(
    override val loser: Loser? = null,
...
fun PolymorphicModuleBuilder<WinAction>.serializableWinAction() {
    subclass(SerializableWinAction::class)
}
