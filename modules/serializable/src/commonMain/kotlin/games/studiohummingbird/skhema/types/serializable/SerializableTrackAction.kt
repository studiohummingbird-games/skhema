...
@Serializable
data class SerializableTrackAction(
...
fun PolymorphicModuleBuilder<TrackAction>.serializableTrackAction() {
    subclass(SerializableTrackAction::class)
}
