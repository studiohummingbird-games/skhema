...
@Serializable
data class SerializableMarryAction(
...
fun PolymorphicModuleBuilder<MarryAction>.serializableMarryAction() {
    subclass(SerializableMarryAction::class)
}
