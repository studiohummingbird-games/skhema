...
import games.studiohummingbird.skhema.types.SeekToAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableSeekToAction(
    override val startOffset: StartOffset? = null,
...
fun PolymorphicModuleBuilder<SeekToAction>.serializableSeekToAction() {
    subclass(SerializableSeekToAction::class)
}
