...
@Serializable
data class SerializableAssessAction(
...
fun PolymorphicModuleBuilder<AssessAction>.serializableAssessAction() {
    subclass(SerializableAssessAction::class)
}
