...
@Serializable
data class SerializableCheckOutAction(
...
fun PolymorphicModuleBuilder<CheckOutAction>.serializableCheckOutAction() {
    subclass(SerializableCheckOutAction::class)
}
