/* SerializableDeactivateAction.kt
...
@Serializable
data class SerializableDeactivateAction(
...
fun PolymorphicModuleBuilder<DeactivateAction>.serializableDeactivateAction() {
    subclass(SerializableDeactivateAction::class)
}
