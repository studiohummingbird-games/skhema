...
@Serializable
data class SerializableWantAction(
...
fun PolymorphicModuleBuilder<WantAction>.serializableWantAction() {
    subclass(SerializableWantAction::class)
}
