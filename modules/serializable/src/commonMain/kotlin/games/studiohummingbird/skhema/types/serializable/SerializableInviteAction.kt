...
@Serializable
data class SerializableInviteAction(
...
fun PolymorphicModuleBuilder<InviteAction>.serializableInviteAction() {
    subclass(SerializableInviteAction::class)
}
