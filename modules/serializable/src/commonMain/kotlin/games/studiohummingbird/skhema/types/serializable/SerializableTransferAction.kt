...
@Serializable
data class SerializableTransferAction(
...
fun PolymorphicModuleBuilder<TransferAction>.serializableTransferAction() {
    subclass(SerializableTransferAction::class)
}
