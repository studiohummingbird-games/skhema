...
@Serializable
data class SerializableMoveAction(
...
fun PolymorphicModuleBuilder<MoveAction>.serializableMoveAction() {
    subclass(SerializableMoveAction::class)
}
