...
@Serializable
data class SerializableSchoolDistrict(
...
fun PolymorphicModuleBuilder<SchoolDistrict>.serializableSchoolDistrict() {
    subclass(SerializableSchoolDistrict::class)
}
