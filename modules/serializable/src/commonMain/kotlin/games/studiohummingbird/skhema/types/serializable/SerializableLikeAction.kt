...
@Serializable
data class SerializableLikeAction(
...
fun PolymorphicModuleBuilder<LikeAction>.serializableLikeAction() {
    subclass(SerializableLikeAction::class)
}
