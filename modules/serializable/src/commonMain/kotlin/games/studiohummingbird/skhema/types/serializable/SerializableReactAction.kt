...
@Serializable
data class SerializableReactAction(
...
fun PolymorphicModuleBuilder<ReactAction>.serializableReactAction() {
    subclass(SerializableReactAction::class)
}
