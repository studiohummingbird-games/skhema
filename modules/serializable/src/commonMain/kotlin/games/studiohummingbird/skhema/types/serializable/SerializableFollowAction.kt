...
@Serializable
data class SerializableFollowAction(
    override val followee: Followee? = null,
...
fun PolymorphicModuleBuilder<FollowAction>.serializableFollowAction() {
    subclass(SerializableFollowAction::class)
}
