...
@Serializable
data class SerializableBioChemEntity(
...
fun PolymorphicModuleBuilder<BioChemEntity>.serializableBioChemEntity() {
    subclass(SerializableBioChemEntity::class)
}
