...
@Serializable
data class SerializableDiscoverAction(
...
fun PolymorphicModuleBuilder<DiscoverAction>.serializableDiscoverAction() {
    subclass(SerializableDiscoverAction::class)
}
