...
@Serializable
data class SerializableResumeAction(
...
fun PolymorphicModuleBuilder<ResumeAction>.serializableResumeAction() {
    subclass(SerializableResumeAction::class)
}
