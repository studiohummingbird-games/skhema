...
@Serializable
data class SerializableCampingPitch(
...
fun PolymorphicModuleBuilder<CampingPitch>.serializableCampingPitch() {
    subclass(SerializableCampingPitch::class)
}
