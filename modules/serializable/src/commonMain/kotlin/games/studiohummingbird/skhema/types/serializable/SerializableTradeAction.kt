...
@Serializable
data class SerializableTradeAction(
...
fun PolymorphicModuleBuilder<TradeAction>.serializableTradeAction() {
    subclass(SerializableTradeAction::class)
}
