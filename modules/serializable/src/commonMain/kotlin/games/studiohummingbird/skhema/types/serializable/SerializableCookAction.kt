...
@Serializable
data class SerializableCookAction(
    override val foodEstablishment: FoodEstablishment? = null,
    override val foodEvent: FoodEvent? = null,
    override val recipe: Recipe? = null,
...
fun PolymorphicModuleBuilder<CookAction>.serializableCookAction() {
    subclass(SerializableCookAction::class)
}
