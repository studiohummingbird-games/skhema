...
import games.studiohummingbird.skhema.types.SellAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableSellAction(
    override val buyer: Buyer? = null,
...
fun PolymorphicModuleBuilder<SellAction>.serializableSellAction() {
    subclass(SerializableSellAction::class)
}
