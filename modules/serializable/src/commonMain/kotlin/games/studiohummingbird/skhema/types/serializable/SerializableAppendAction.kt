...
@Serializable
data class SerializableAppendAction(
...
fun PolymorphicModuleBuilder<AppendAction>.serializableAppendAction() {
    subclass(SerializableAppendAction::class)
}
