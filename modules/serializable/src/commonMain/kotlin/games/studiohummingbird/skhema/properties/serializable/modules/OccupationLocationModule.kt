...
import games.studiohummingbird.skhema.properties.OccupationLocation
...
val OccupationLocationModule = SerializersModule {
    polymorphic(OccupationLocation::class) {
