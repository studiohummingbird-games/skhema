...
import games.studiohummingbird.skhema.types.BorrowAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableBorrowAction(
    override val lender: Lender? = null,
...
fun PolymorphicModuleBuilder<BorrowAction>.serializableBorrowAction() {
    subclass(SerializableBorrowAction::class)
}
