...
@Serializable
data class SerializableCreateAction(
...
fun PolymorphicModuleBuilder<CreateAction>.serializableCreateAction() {
    subclass(SerializableCreateAction::class)
}
