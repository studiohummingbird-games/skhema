...
@Serializable
data class SerializableInstallAction(
...
fun PolymorphicModuleBuilder<InstallAction>.serializableInstallAction() {
    subclass(SerializableInstallAction::class)
}
