...
@Serializable
data class SerializablePlayAction(
...
fun PolymorphicModuleBuilder<PlayAction>.serializablePlayAction() {
    subclass(SerializablePlayAction::class)
}
