...
@Serializable
data class SerializableAddAction(
...
fun PolymorphicModuleBuilder<AddAction>.serializableAddAction() {
    subclass(SerializableAddAction::class)
}
