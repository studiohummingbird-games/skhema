...
@Serializable
data class SerializableIntangible(
...
fun PolymorphicModuleBuilder<Intangible>.serializableIntangible() {
    subclass(SerializableIntangible::class)
}
