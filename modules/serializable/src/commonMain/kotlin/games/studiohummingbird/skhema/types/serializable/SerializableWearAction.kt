...
@Serializable
data class SerializableWearAction(
...
fun PolymorphicModuleBuilder<WearAction>.serializableWearAction() {
    subclass(SerializableWearAction::class)
}
