...
@Serializable
data class SerializableRejectAction(
...
fun PolymorphicModuleBuilder<RejectAction>.serializableRejectAction() {
    subclass(SerializableRejectAction::class)
}
