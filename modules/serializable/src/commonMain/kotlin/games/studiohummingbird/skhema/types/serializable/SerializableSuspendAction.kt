...
@Serializable
data class SerializableSuspendAction(
...
fun PolymorphicModuleBuilder<SuspendAction>.serializableSuspendAction() {
    subclass(SerializableSuspendAction::class)
}
