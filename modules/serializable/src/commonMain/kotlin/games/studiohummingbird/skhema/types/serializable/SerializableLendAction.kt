...
@Serializable
data class SerializableLendAction(
    override val borrower: Borrower? = null,
...
fun PolymorphicModuleBuilder<LendAction>.serializableLendAction() {
    subclass(SerializableLendAction::class)
}
