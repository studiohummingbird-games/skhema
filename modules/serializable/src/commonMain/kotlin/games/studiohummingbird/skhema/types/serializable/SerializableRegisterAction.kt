...
@Serializable
data class SerializableRegisterAction(
...
fun PolymorphicModuleBuilder<RegisterAction>.serializableRegisterAction() {
    subclass(SerializableRegisterAction::class)
}
