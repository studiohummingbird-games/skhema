...
import games.studiohummingbird.skhema.types.DonateAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableDonateAction(
    override val price: Price? = null,
    override val priceCurrency: PriceCurrency? = null,
    override val priceSpecification: PriceSpecification? = null,
    override val recipient: Recipient? = null,
...
fun PolymorphicModuleBuilder<DonateAction>.serializableDonateAction() {
    subclass(SerializableDonateAction::class)
}
