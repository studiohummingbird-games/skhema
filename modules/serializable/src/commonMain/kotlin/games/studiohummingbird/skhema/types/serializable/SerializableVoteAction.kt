...
import games.studiohummingbird.skhema.types.VoteAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableVoteAction(
    override val candidate: Candidate? = null,
    override val actionOption: ActionOption? = null,
...
fun PolymorphicModuleBuilder<VoteAction>.serializableVoteAction() {
    subclass(SerializableVoteAction::class)
}
