...
@Serializable
data class SerializableInformAction(
...
fun PolymorphicModuleBuilder<InformAction>.serializableInformAction() {
    subclass(SerializableInformAction::class)
}
