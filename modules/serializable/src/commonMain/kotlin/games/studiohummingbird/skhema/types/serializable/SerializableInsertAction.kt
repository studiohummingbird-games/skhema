...
@Serializable
data class SerializableInsertAction(
...
fun PolymorphicModuleBuilder<InsertAction>.serializableInsertAction() {
    subclass(SerializableInsertAction::class)
}
