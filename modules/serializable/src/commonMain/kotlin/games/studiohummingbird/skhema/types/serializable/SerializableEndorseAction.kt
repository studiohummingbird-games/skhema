...
import games.studiohummingbird.skhema.types.EndorseAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableEndorseAction(
    override val endorsee: Endorsee? = null,
...
fun PolymorphicModuleBuilder<EndorseAction>.serializableEndorseAction() {
    subclass(SerializableEndorseAction::class)
}
