...
@Serializable
data class SerializablePayAction(
...
fun PolymorphicModuleBuilder<PayAction>.serializablePayAction() {
    subclass(SerializablePayAction::class)
}
