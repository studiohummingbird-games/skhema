...
@Serializable
data class SerializableConfirmAction(
...
fun PolymorphicModuleBuilder<ConfirmAction>.serializableConfirmAction() {
    subclass(SerializableConfirmAction::class)
}
