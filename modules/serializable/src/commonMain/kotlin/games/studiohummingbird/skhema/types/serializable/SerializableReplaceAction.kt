...
import games.studiohummingbird.skhema.types.ReplaceAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableReplaceAction(
    override val replacee: Replacee? = null,
    override val replacer: Replacer? = null,
    override val targetCollection: TargetCollection? = null,
...
fun PolymorphicModuleBuilder<ReplaceAction>.serializableReplaceAction() {
    subclass(SerializableReplaceAction::class)
}
