...
@Serializable
data class SerializableHotelRoom(
...
fun PolymorphicModuleBuilder<HotelRoom>.serializableHotelRoom() {
    subclass(SerializableHotelRoom::class)
}
