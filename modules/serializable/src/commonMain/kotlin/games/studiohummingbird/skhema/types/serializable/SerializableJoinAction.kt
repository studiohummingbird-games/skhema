...
@Serializable
data class SerializableJoinAction(
...
fun PolymorphicModuleBuilder<JoinAction>.serializableJoinAction() {
    subclass(SerializableJoinAction::class)
}
