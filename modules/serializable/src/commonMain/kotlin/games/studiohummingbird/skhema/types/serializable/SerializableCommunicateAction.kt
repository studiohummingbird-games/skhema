/* SerializableCommunicateAction.kt
...
@Serializable
data class SerializableCommunicateAction(
...
fun PolymorphicModuleBuilder<CommunicateAction>.serializableCommunicateAction() {
    subclass(SerializableCommunicateAction::class)
}
