...
@Serializable
data class SerializableConsumeAction(
...
fun PolymorphicModuleBuilder<ConsumeAction>.serializableConsumeAction() {
    subclass(SerializableConsumeAction::class)
}
