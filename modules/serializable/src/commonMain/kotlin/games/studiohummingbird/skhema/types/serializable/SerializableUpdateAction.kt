...
@Serializable
data class SerializableUpdateAction(
...
fun PolymorphicModuleBuilder<UpdateAction>.serializableUpdateAction() {
    subclass(SerializableUpdateAction::class)
}
