...
@Serializable
data class SerializableSearchAction(
...
fun PolymorphicModuleBuilder<SearchAction>.serializableSearchAction() {
    subclass(SerializableSearchAction::class)
}
