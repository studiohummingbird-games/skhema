...
@Serializable
data class SerializablePerformAction(
    override val entertainmentBusiness: EntertainmentBusiness? = null,
...
fun PolymorphicModuleBuilder<PerformAction>.serializablePerformAction() {
    subclass(SerializablePerformAction::class)
}
