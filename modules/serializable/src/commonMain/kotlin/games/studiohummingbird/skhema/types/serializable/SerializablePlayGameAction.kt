...
import games.studiohummingbird.skhema.types.PlayGameAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializablePlayGameAction(
    override val gameAvailabilityType: GameAvailabilityType? = null,
    override val actionAccessibilityRequirement: ActionAccessibilityRequirement? = null,
    override val expectsAcceptanceOf: ExpectsAcceptanceOf? = null,
...
fun PolymorphicModuleBuilder<PlayGameAction>.serializablePlayGameAction() {
    subclass(SerializablePlayGameAction::class)
}
