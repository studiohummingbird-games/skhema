...
@Serializable
data class SerializableLeaveAction(
...
fun PolymorphicModuleBuilder<LeaveAction>.serializableLeaveAction() {
    subclass(SerializableLeaveAction::class)
}
