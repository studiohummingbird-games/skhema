...
import games.studiohummingbird.skhema.types.RsvpAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableRsvpAction(
    override val additionalNumberOfGuests: AdditionalNumberOfGuests? = null,
    override val comment: Comment? = null,
    override val rsvpResponse: RsvpResponse? = null,
...
fun PolymorphicModuleBuilder<RsvpAction>.serializableRsvpAction() {
    subclass(SerializableRsvpAction::class)
}
