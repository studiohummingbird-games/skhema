...
import games.studiohummingbird.skhema.types.RentAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableRentAction(
    override val landlord: Landlord? = null,
    override val realEstateAgent: RealEstateAgent? = null,
...
fun PolymorphicModuleBuilder<RentAction>.serializableRentAction() {
    subclass(SerializableRentAction::class)
}
