...
@Serializable
data class SerializableControlAction(
...
fun PolymorphicModuleBuilder<ControlAction>.serializableControlAction() {
    subclass(SerializableControlAction::class)
}
