...
@Serializable
data class SerializableAskAction(
...
fun PolymorphicModuleBuilder<AskAction>.serializableAskAction() {
    subclass(SerializableAskAction::class)
}
