...
import games.studiohummingbird.skhema.types.IgnoreAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableIgnoreAction(
...
fun PolymorphicModuleBuilder<IgnoreAction>.serializableIgnoreAction() {
    subclass(SerializableIgnoreAction::class)
}
