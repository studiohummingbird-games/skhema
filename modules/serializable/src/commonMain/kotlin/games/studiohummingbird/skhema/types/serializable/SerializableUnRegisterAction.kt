/* SerializableUnRegisterAction.kt
...
@Serializable
data class SerializableUnRegisterAction(
...
fun PolymorphicModuleBuilder<UnRegisterAction>.serializableUnRegisterAction() {
    subclass(SerializableUnRegisterAction::class)
}
