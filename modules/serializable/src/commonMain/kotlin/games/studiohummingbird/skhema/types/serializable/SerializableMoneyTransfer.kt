...
import games.studiohummingbird.skhema.types.MoneyTransfer
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableMoneyTransfer(
    override val amount: Amount? = null,
    override val beneficiaryBank: BeneficiaryBank? = null,
...
fun PolymorphicModuleBuilder<MoneyTransfer>.serializableMoneyTransfer() {
    subclass(SerializableMoneyTransfer::class)
}
