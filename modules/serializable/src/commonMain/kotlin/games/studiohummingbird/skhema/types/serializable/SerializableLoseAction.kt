...
import games.studiohummingbird.skhema.types.LoseAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableLoseAction(
    override val winner: Winner? = null,
...
fun PolymorphicModuleBuilder<LoseAction>.serializableLoseAction() {
    subclass(SerializableLoseAction::class)
}
