...
@Serializable
data class SerializableBookmarkAction(
...
fun PolymorphicModuleBuilder<BookmarkAction>.serializableBookmarkAction() {
    subclass(SerializableBookmarkAction::class)
}
