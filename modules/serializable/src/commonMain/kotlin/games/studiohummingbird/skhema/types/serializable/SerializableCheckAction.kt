...
@Serializable
data class SerializableCheckAction(
...
fun PolymorphicModuleBuilder<CheckAction>.serializableCheckAction() {
    subclass(SerializableCheckAction::class)
}
