...
import games.studiohummingbird.skhema.types.CommentAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableCommentAction(
    override val resultComment: ResultComment? = null,
...
fun PolymorphicModuleBuilder<CommentAction>.serializableCommentAction() {
    subclass(SerializableCommentAction::class)
}
