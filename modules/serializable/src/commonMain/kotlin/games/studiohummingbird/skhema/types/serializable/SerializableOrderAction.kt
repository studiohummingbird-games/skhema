...
import games.studiohummingbird.skhema.types.OrderAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableOrderAction(
    override val deliveryMethod: DeliveryMethod? = null,
...
fun PolymorphicModuleBuilder<OrderAction>.serializableOrderAction() {
    subclass(SerializableOrderAction::class)
}
