...
@Serializable
data class SerializableAchieveAction(
...
fun PolymorphicModuleBuilder<AchieveAction>.serializableAchieveAction() {
    subclass(SerializableAchieveAction::class)
}
