...
@Serializable
data class SerializableApplyAction(
...
fun PolymorphicModuleBuilder<ApplyAction>.serializableApplyAction() {
    subclass(SerializableApplyAction::class)
}
