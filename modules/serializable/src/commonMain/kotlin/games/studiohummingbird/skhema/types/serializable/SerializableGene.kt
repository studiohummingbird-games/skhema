...
import games.studiohummingbird.skhema.types.Gene
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableGene(
    override val alternativeOf: AlternativeOf? = null,
    override val encodesBioChemEntity: EncodesBioChemEntity? = null,
    override val expressedIn: ExpressedIn? = null,
    override val hasBioPolymerSequence: HasBioPolymerSequence? = null,
...
fun PolymorphicModuleBuilder<Gene>.serializableGene() {
    subclass(SerializableGene::class)
}
