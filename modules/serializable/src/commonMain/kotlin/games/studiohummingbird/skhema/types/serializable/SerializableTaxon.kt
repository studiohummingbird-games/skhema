...
import games.studiohummingbird.skhema.types.Taxon
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableTaxon(
    override val childTaxon: ChildTaxon? = null,
    override val hasDefinedTerm: HasDefinedTerm? = null,
    override val parentTaxon: ParentTaxon? = null,
    override val taxonRank: TaxonRank? = null,
...
fun PolymorphicModuleBuilder<Taxon>.serializableTaxon() {
    subclass(SerializableTaxon::class)
}
