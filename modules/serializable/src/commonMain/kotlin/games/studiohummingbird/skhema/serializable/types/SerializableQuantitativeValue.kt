/* SerializableQuantitativeValue.kt
...
@Serializable
data class SerializableQuantitativeValue(
...
fun PolymorphicModuleBuilder<QuantitativeValue>.serializableQuantitativeValue() {
    subclass(SerializableQuantitativeValue::class)
}
