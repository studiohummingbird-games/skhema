...
@Serializable
data class SerializableChooseAction(
...
fun PolymorphicModuleBuilder<ChooseAction>.serializableChooseAction() {
    subclass(SerializableChooseAction::class)
}
