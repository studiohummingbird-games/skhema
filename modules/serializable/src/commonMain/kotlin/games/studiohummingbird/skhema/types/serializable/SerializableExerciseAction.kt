...
import games.studiohummingbird.skhema.types.ExerciseAction
import kotlinx.serialization.Serializable
import kotlinx.serialization.modules.PolymorphicModuleBuilder
import kotlinx.serialization.modules.subclass

@Serializable
data class SerializableExerciseAction(
    override val diet: Diet? = null,
    override val distance: Distance? = null,
    override val exerciseCourse: ExerciseCourse? = null,
    override val exercisePlan: ExercisePlan? = null,
    override val exerciseRelatedDiet: ExerciseRelatedDiet? = null,
    override val exerciseType: ExerciseType? = null,
    override val fromLocation: FromLocation? = null,
    override val opponent: Opponent? = null,
    override val sportsActivityLocation: SportsActivityLocation? = null,
    override val sportsEvent: SportsEvent? = null,
    override val sportsTeam: SportsTeam? = null,
    override val toLocation: ToLocation? = null,
...
fun PolymorphicModuleBuilder<ExerciseAction>.serializableExerciseAction() {
    subclass(SerializableExerciseAction::class)
}
