...
@Serializable
data class SerializablePrependAction(
...
fun PolymorphicModuleBuilder<PrependAction>.serializablePrependAction() {
    subclass(SerializablePrependAction::class)
}
